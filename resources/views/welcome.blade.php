...
<html lang="en-US">
  <head>
    ...
    <link rel="stylesheet" href="Main-layout/css/lightcase.css">
    <!-- CUSTOM STYLE -->      
        ...
        <div class="top-nav"> 
          ...
          <div class="logo hide-l hide-xl hide-xxl">
             <a href="index.html" class="logo">
              <!-- Logo White Version -->
              <img class="logo-white" src="Main-layout/img/logo.svg" alt="">
              <!-- Logo Dark Version -->
              <img class="logo-dark" src="Main-layout/img/logo-dark.svg" alt="">
            </a>
          </div>                  
          <p class="nav-text"></p>
  ...
  @endif
    ...
    <main role="main">    
      <!-- Header -->
      <header class="section-top-padding background-image text-center" style="background-image:url(Main-layout/img/BG01.jpg)">
          ...
          <div class="margin">
            ...
            <div class="s-12 m-12 l-4">                                                                                        
              <div class="carousel-default owl-carousel carousel-hide-arrows margin-m-top-bottom-50">                                                                                              
                <div class="item">                                                                                                                                                                                                     
                  <img src="Main-layout/img/responsive-01.png"/>                                                                                                                                                              
                </div>              
                <div class="item">                                                                                                                                                                                                                 
                  <img src="Main-layout/img/responsive-02.png"/>                                                                                                                                                                                                                                                                                                                                                                                     
                </div>              
                <div class="item">                                                                                                                                                                                                     
                  <img src="Main-layout/img/responsive-03.png"/>                                                                                                                                                            
                </div>              
                <div class="item">
                  <img src="Main-layout/img/responsive-04.png"/>                                                                                                                                                            
                </div>                                                                                                                                      
              </div>
            </div> 
      ...
      <section class="background-primary full-width">        
        <div class="m-12 l-6 xl-5 xxl-4">
          <img class="full-img" src="Main-layout/img/img-02.jpg"/>
        </div>         
        <div class="m-12 l-6 xl-7 xxl-8">
          <div class="l-12 xl-11 xxl-8 padding-2x">
            ...
            <img class="margin-left-20 margin-top-30 margin-bottom-60" src="Main-layout/img/start-your-business.svg" alt="">
          </div>  
        </div>
      </section>
      ...
      <section class="section-small-padding background-grey">   
        <div class="margin2x">
           <div class="m-6 l-1">
              <img class="margin-bottom" src="Main-layout/img/logo-1.png"/>
           </div>
           <div class="m-6 l-1">
              <img class="margin-bottom" src="Main-layout/img/logo-2.png"/>
           </div>
           <div class="m-6 l-1">
              <img class="margin-bottom" src="Main-layout/img/logo-3.png"/>
           </div>
           <div class="m-6 l-1">
              <img class="margin-bottom" src="Main-layout/img/logo-1.png"/>
           </div>
           <div class="m-6 l-1">
              <img class="margin-bottom" src="Main-layout/img/logo-4.png"/>
           </div>
           <div class="m-6 l-1">
              <img class="margin-bottom" src="Main-layout/img/logo-5.png"/>
           </div>
           <div class="m-6 l-1">
              <img class="margin-bottom" src="Main-layout/img/logo-3.png"/>
           </div>
