...
<body>
<div class="Content">
<h1 style="text-align:center;margin-bottom:4%;">EMS  POWER CUSTOM DATE FROM {{$Startdate}} TO {{$Stopdate}}</h1>
...
<script>
 $.getJSON('/EmsgetOverviewPowerCustomDate?Startdate={{$Startdate}}&Stopdate={{$Stopdate}}', function(data){
