...
<body>
<div class="Content">
<h1 style="text-align:center;margin-bottom:4%;">EMS  ENERGY CUSTOM DATE FROM {{$Startdate}} TO {{$Stopdate}}</h1>
...
<script>
  ...
  $.getJSON('/EmsgetOverviewEnergyCustomDate?Startdate={{$Startdate}}&Stopdate={{$Stopdate}}', function(data){
